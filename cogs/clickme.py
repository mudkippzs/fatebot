        ...
        for guild in self.bot.guilds:
            if guild.id in guild_whitelist:
                ...
                for i in range(len(pb_leaderboard)):
                    ...
                    if index == 0:
                        role = discord.utils.get(guild.roles, name=roles[0])  # Gold Role ID: 707926590981440779
                    elif index == 1:
                        role = discord.utils.get(guild.roles, name=roles[1])  # Silver Role ID: 707926590981440781
                    elif index == 2:
                        role = discord.utils.get(guild.roles, name=roles[2])  # Bronze Role ID: 707926590981440781
                    else:
                        role = discord.utils.get(guild.roles, name=roles[3])  # Contender Role ID: 707926590981440781
