    ...
    for pantheon in PANTHEONS:
        for god in PANTHEONS[pantheon]["gods"]:
            if "rivals" in PANTHEONS[pantheon]["gods"][god].keys():
                rivals = [r.lower()
                          for r in PANTHEONS[pantheon]["gods"][god]["rivals"]]
    ...
    for pantheon in PANTHEONS:
        for god in PANTHEONS[pantheon]["gods"]:
            if "favoured" in PANTHEONS[pantheon]["gods"][god].keys():
                favoured_abilities = [f for f in PANTHEONS[pantheon]["gods"][god]
                                      ["favoured"]["abilities"] if f.lower().startswith(term.lower())]
                favoured_epic_attributes = [f for f in PANTHEONS[pantheon]["gods"][god]
                                            ["favoured"]["epic_attributes"] if f.lower().startswith(term.lower())]
                favoured_purviews = [f for f in PANTHEONS[pantheon]["gods"][god]
                                     ["favoured"]["purviews"] if f.lower().startswith(term.lower())]
